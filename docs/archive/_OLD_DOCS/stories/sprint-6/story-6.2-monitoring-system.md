...
2. **Metrics collection and aggregation**
   ...
   class MetricsCollector {
     ...
     private registerDefaultMetrics() {
       ...
       this.histograms.set(
         'response_time',
         this.meter.createHistogram('response_time', {
       ...
       this.counters.set(
         'content_generated',
         this.meter.createCounter('content_generated', {
       ...
       this.histograms.set(
         'generation_time',
         this.meter.createHistogram('generation_time', {
     ...
     return (
       <div className="monitoring-dashboard">
         ...
         <div className="monitoring-sections">
           ...
           <AlertsList alerts={alerts} onAcknowledge={(id) => acknowledgeAlert(id)} />

           <LogViewer logs={logs} onSearch={(query) => searchLogs(query)} />
