...
- [ ] Simplify SimpleProductCard component (AC: 1-2)
  - [ ] Remove availability badge, secondary price info (keep brand)
  - [ ] Increase image height to 60% of card space
  - [ ] Implement single-line title with truncation
  - [ ] Position price and brand prominently at bottom

- [ ] Add click interaction (AC: 3)
  - [ ] Make entire card clickable area
  - [ ] Add onProductClick prop to component interface
  - [ ] Implement hover effects (scale, border change)
  - [ ] Add click animation feedback

- [ ] Ensure grid compatibility (AC: 4)
  - [ ] Test responsive grid behavior unchanged
  - [ ] Verify zoom functionality still works
  - [ ] Confirm spacing and breakpoints maintained
  - [ ] Test parent component integration

- [ ] Performance optimization (AC: 6)
  - [ ] Remove unnecessary conditional rendering
  - [ ] Simplify component structure
  - [ ] Maintain image lazy loading
  - [ ] Verify rendering performance improvement
